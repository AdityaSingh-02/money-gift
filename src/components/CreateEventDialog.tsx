        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="w-full">
            <span className="flex flex-col">
              <p className="py-[10px] font-semibold">Event Name</p>
              <Input
            ...
            <span className="flex flex-col">
              <p className="py-[10px] font-semibold">Event Venue</p>
              <Input
                placeholder="Event Venue"
                onChange={(e) => dispatch(setEventVenue(e.target.value))}
              />
            </span>
            <span className="flex flex-col">
              <p className="py-[10px] font-semibold">Date</p>
              <CalenderDatePicker />
            </span>
